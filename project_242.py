...
print("No of Blocks in Blockchain_data: ",Number_of_blocks)



# Write Task 02 code from below
print("previous_hashcode of Genesis block: ",blockchain.chain[0]['previous_hash'])
print("current_hashcode of Genesis block: ",blockchain.chain[0]['Current_hash'])
print("previous_hashcode of first block: ",blockchain.chain[1]['previous_hash'])

# Write Task 03 code from below
if blockchain.chain[0]['Current_hash'] == blockchain.chain[1]['previous_hash']:
    print("the hash of current match eith previous cblock hench tenasation verified")
else:    
    print("LOL")
